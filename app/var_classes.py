...
COLOR_RECTANGLE_START = '#42f5d1'
COLOR_POLYGON_START = '#f5429c'
COLOR_CIRCLE_START = '#efc050'

CONTRIBUTOR_TAG = 'XMP-iptcExt:Contributor'
EXTRA_TAG = "XMP-dc:Description"
FINE_TUNER_ROLE = 'https://blblabla/regionfinetuner'
DESCRIBER_ROLE = 'https://blblabla/transcriber'
REGION_CREATOR_ROLE = 'https://blblabla/regioncreator'
